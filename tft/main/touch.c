/*
 * touch.c - XPT2046 resistiver Touch (tft, OPTIONAL) ueber SPI (separater Bus SPI3)
 *
 * Im tft-Projekt per Default DEAKTIVIERT (TFT_HAVE_TOUCH=0 in config.h) -
 * der Display-Bring-up hat Vorrang. Beim Aktivieren die Pins in config.h an
 * dein Modul anpassen! Typische 2.8"-Module teilen SCK/MOSI/MISO mit dem
 * Display (nur CS+IRQ separat) - dann muss dieser Treiber auf den geteilten
 * Bus umgestellt werden.
 */
